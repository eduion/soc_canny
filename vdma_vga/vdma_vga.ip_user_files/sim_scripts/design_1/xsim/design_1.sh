...
xv_boost_lib_path=D:/vivado_2019/Vivado/2019.1/tps/boost_1_64_0
...
{
  file="xsim.ini"
  lib_map_path="D:/vivado_2019/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
